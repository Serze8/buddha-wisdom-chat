...
const translations: Record<Locale, TranslationKeys> = {
  en: {
    nav: {
      home: 'Home', dharmaChats: 'Dharma Chats', characters: 'Characters', episodes: 'Series',
      ...
      buddha: 'Buddha', chakravartin: 'Chakravartin',
    },
    home: {
      heroTitle: 'Buddha-Chakravartin Chat',
  ...
  ru: {
    nav: {
      home: 'Главная', dharmaChats: 'Дхарма-беседы', characters: 'Герои Будды', episodes: 'Сериал',
      ...
      buddha: 'Будда', chakravartin: 'Чакравартин',
    },
    home: {
      heroTitle: 'Buddha-Chakravartin Chat',
  ...
  hi: {
    nav: {
      home: 'होम', dharmaChats: 'सामुदायिक चैट', characters: 'पात्र', episodes: 'सीरीज़',
      ...
      buddha: 'बुद्ध', chakravartin: 'चक्रवर्तिन',
    },
    home: {
  ...
  es: {
    nav: {
      home: 'Inicio', dharmaChats: 'Chat comunitario', characters: 'Personajes', episodes: 'Serie',
      ...
      buddha: 'Buda', chakravartin: 'Chakravartin',
    },
    home: {
  ...
  fr: {
    nav: {
      home: 'Accueil', dharmaChats: 'Chat communautaire', characters: 'Personnages', episodes: 'Série',
      ...
      buddha: 'Bouddha', chakravartin: 'Chakravartin',
    },
    home: {
  ...
  de: {
    nav: {
      home: 'Startseite', dharmaChats: 'Community-Chat', characters: 'Charaktere', episodes: 'Serie',
  ...
  zh: {
    nav: {
      home: '首页', dharmaChats: '社区聊天', characters: '角色', episodes: '系列',
  ...
  ja: {
    nav: {
      home: 'ホーム', dharmaChats: 'コミュニティチャット', characters: 'キャラクター', episodes: 'シリーズ',
      ...
      buddha: '仏陀', chakravartin: 'チャクラヴァルティン',
    },
    home: {
  ...
  pt: {
    nav: {
      home: 'Início', dharmaChats: 'Chat da comunidade', characters: 'Personagens', episodes: 'Série',
  ...
  th: {
    nav: {
      home: 'หน้าแรก', dharmaChats: 'แชทชุมชน', characters: 'ตัวละคร', episodes: 'ซีรีส์',
      ...
      buddha: 'พระพุทธเจ้า', chakravartin: 'จักรพรรดิ',
    },
    home: {
  ...
  vi: {
    nav: {
      home: 'Trang chủ', dharmaChats: 'Trò chuyện cộng đồng', characters: 'Nhân vật', episodes: 'Phim',
      ...
      buddha: 'Phật', chakravartin: 'Chakravartin',
    },
    home: {
  ...
  ko: {
    nav: {
      home: '홈', dharmaChats: '커뮤니티 채팅', characters: '인물', episodes: '시리즈',
  ...
  id: {
    nav: {
      home: 'Beranda', dharmaChats: 'Obrolan komunitas', characters: 'Karakter', episodes: 'Serial',
  ...
  ms: {
    nav: {
      home: 'Laman Utama', dharmaChats: 'Sembang komuniti', characters: 'Watak', episodes: 'Siri',
  ...
  si: {
    nav: {
      home: 'මුල් පිටුව', dharmaChats: 'ප්‍රජා කතාබහ', characters: 'චරිත', episodes: 'ශ්‍රේණිය',
      ...
      buddha: 'බුදුන්', chakravartin: 'චක්‍රවර්ති',
    },
    home: {
  ...
  my: {
    nav: {
      home: 'ပင်မစာမျက်နှာ', dharmaChats: 'ရပ်ရွာချတ်', characters: 'ဇာတ်ကောင်', episodes: 'စီးရီး',
      ...
      buddha: 'ဗုဒ္ဓ', chakravartin: 'စကြဝတေးမင်း',
    },
    home: {
  ...
  ne: {
    nav: {
      home: 'गृहपृष्ठ', dharmaChats: 'सामुदायिक च्याट', characters: 'पात्र', episodes: 'श्रृंखला',
      ...
      buddha: 'बुद्ध', chakravartin: 'चक्रवर्ती',
    },
    home: {
  ...
  bo: {
    nav: {
      home: 'གཙོ་ངོས།', dharmaChats: 'སྤྱི་ཚོགས་གླེང་མོལ།', characters: 'སྒྲུང་མི།', episodes: 'སྒྲུང་།',
      ...
      buddha: 'སངས་རྒྱས།', chakravartin: 'འཁོར་ལོས་སྒྱུར་བ།',
    },
    home: {
