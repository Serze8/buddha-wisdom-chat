...
const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    zen: {
      title: 'The Rise of Zen — Bodhidharma & Martial Arts',
      ...
      bodhidharmaDesc: 'Bodhidharma is a semi-legendary Buddhist monk who lived during the 5th–6th century. He is credited as the founder of Chan (Zen) Buddhism. According to tradition, he was the 27th or 28th Patriarch of Buddhism and brought the teachings from India to China, settling at the Shaolin Monastery. There, legend says he meditated facing a wall for nine years and taught the monks physical exercises that became the foundation of Shaolin Kung Fu.',
      sectionRiver: 'Water Margin (1998)',
      riverTitle: 'Water Margin — Chinese Classic',
      riverDesc: 'A 43-episode Chinese historical drama based on one of the Four Great Classical Novels of Chinese literature. The story follows 108 outlaws who gather at Mount Liang to form an army. It explores themes of loyalty, honor, justice, and the Buddhist concept of karma — how actions ripple through existence. A profound meditation on the intersection of martial prowess and moral virtue.',
      ...
      sectionFilms: 'More Films & Series',
      filmsTitle: 'Buddhist Cinema',
      filmsDesc: 'A curated collection of films and series that explore Buddhist themes through the lens of martial arts, philosophy, and Eastern wisdom.',
  ...
  ru: {
    ...
    home: {
      ...
      blockZenTitle: 'Возникновение Дзен — боевые искусства',
    ...
    zen: {
      title: 'Возникновение Дзен — Бодхидхарма и боевые искусства',
      ...
      bodhidharmaDesc: 'Бодхидхарма — полу-легендарный буддийский монах V–VI века. Он считается основателем Чань (Дзен) буддизма. Согласно традиции, он был 27-м или 28-м патриархом буддизма и принёс учения из Индии в Китай, поселившись в монастыре Шаолинь. Там, по преданию, он медитировал лицом к стене девять лет и учил монахов физическим упражнениям, ставшим основой Шаолиньского кунг-фу.',
      sectionRiver: 'Речные заводи (1998)',
      riverTitle: 'Речные заводи — китайская классика',
      riverDesc: '43-серийный китайский исторический сериал, основанный на одном из четырёх великих классических романов китайской литературы. История о 108 разбойниках, собравшихся на горе Лян. Сериал исследует темы чести, справедливости и буддийского учения о карме — как наши действия отаются во вселенной.',
      ...
      sectionFilms: 'Другие фильмы и сериалы',
      filmsTitle: 'Буддийское кино',
      filmsDesc: 'Подборка фильмов и сериалов, исследующих буддийские темы через призму боевых искусств, философии и восточной мудрости.',
  ...
  hi: {
    ...
    zen: {
      title: 'द्ज़ेन का उदय — बोधिधर्म और मार्शल आर्ट्स',
      ...
      bodhidharmaDesc: 'बोधिधर्म एक अर्ध-पौराणिक बौद्ध भिक्षु हैं जो 5वीं-6वीं शताब्दी में रहे। उन्हें चान (द्ज़ेन) बौद्ध धर्म के संस्थापक के रूप में माना जाता है।',
      sectionRiver: 'रीचर फैक्ट्री (1998)',
      riverTitle: 'रीचर फैक्ट्री — चीनी शास्त्रीय कृति',
      riverDesc: '43-एपिसोड का चीनी ऐतिहासिक नाटक, जो चीनी साहित्य के चार महान शास्त्रीय उपन्यासों में से एक पर आधारित है। 108 डाकुओं की कहानी।',
      ...
      sectionFilms: 'अन्य फिल्में और सीरीज़',
      filmsTitle: 'बौद्ध सिनेमा',
      filmsDesc: 'बौद्ध विषयों की खोज करने वाली फिल्मों और सीरीज़ का संग्रह।',
  ...
  es: {
    ...
    zen: {
      title: 'El Surgimiento del Zen — Bodhidharma y Artes Marciales',
      intro: 'La historia de Bodhidharma (Daruma) — el 24° patriarca del budismo que trajo el Chan (Zen) a China.',
      sectionBodhidharma: 'Bodhidharma (Daruma)',
      bodhidharmaDesc: 'Bodhidharma es un monje budista semi-legendario del siglo V-VI. Se le atribuye la fundación del budismo Chan (Zen).',
      sectionRiver: 'La Ruta del Agua (1998)',
      riverTitle: 'La Ruta del Agua — Clásico Chino',
      riverDesc: 'Un drama histórico chino de 43 episodios basado en una de las cuatro grandes novelas clásicas de la literatura china.',
      ...
      sectionFilms: 'Más Películas y Series',
      filmsTitle: 'Cine Budista',
      filmsDesc: 'Una colección seleccionada de películas y series que exploran temas budistas.',
  ...
  fr: {
    ...
    zen: {
      title: 'L\'Avènement du Zen — Bodhidharma et Arts Martiaux',
      intro: 'L\'histoire de Bodhidharma (Daruma) — le 24ème patriarche du bouddhisme qui apporta le Chan (Zen) en Chine.',
      sectionBodhidharma: 'Bodhidharma (Daruma)',
      bodhidharmaDesc: 'Bodhidharma est un moine bouddhiste semi-légendaire du Ve-VIe siècle. Il est considéré comme le fondateur du bouddhisme Chan (Zen).',
      sectionRiver: 'Au Bord de l\'Eau (1998)',
      riverTitle: 'Au Bord de l\'Eau — Classique Chinois',
      riverDesc: 'Un drame historique chinois de 43 épisodes basé sur l\'un des quatre grands romans classiques de la littérature chinoise.',
      ...
      sectionFilms: 'Autres Films et Séries',
      filmsTitle: 'Cinéma Bouddhiste',
      filmsDesc: 'Une collection de films et séries explorant les thèmes bouddhistes.',
  ...
  de: {
    ...
    zen: {
      title: 'Das Entstehens des Zen — Bodhidharma und Kampfkünste',
      intro: 'Die Geschichte von Bodhidharma (Daruma) — dem 24. Patriarchen des Buddhismus, der Chan (Zen) nach China brachte.',
      sectionBodhidharma: 'Bodhidharma (Daruma)',
      bodhidharmaDesc: 'Bodhidharma ist ein halb-legendarischer buddhistischer Mönch des 5.-6. Jahrhunderts. Er gilt als Begründer des Chan (Zen)-Buddhismus.',
      sectionRiver: 'Am Wasser (1998)',
      riverTitle: 'Am Wasser — Chinesisches Klassikwerk',
      riverDesc: 'Eine 43 Episoden umfassende chinesische historische Drama-Serie, basierend auf einem der vier großen klassischen Romane der chinesischen Literatur.',
      ...
      sectionFilms: 'Weitere Filme und Serien',
      filmsTitle: 'Buddhistischer Film',
      filmsDesc: 'Eine kuratierte Sammlung von Filmen und Serien zu buddhistischen Themen.',
  ...
  zh: {
    ...
    zen: {
      ...
      bodhidharmaDesc: '菩提达摩是5-6世纪的半传奇佛教僧人。他被认为是禅宗的创始人。',
      sectionRiver: '水浒传（1998）',
      riverTitle: '水浒传 — 中国古典名著',
      riverDesc: '43集中国历史剧，改编自中国文学四大名著之一。108位好汉的故事。',
      sectionShaolin: '少林电影',
      shaolinTitle: '少林寺',
      shaolinDesc: '关于传奇少林寺及其武僧的电影。',
      sectionFilms: '其他电影和电视剧',
      filmsTitle: '佛教电影',
      filmsDesc: '探索佛教主题的电影和电视剧精选。',
  ...
  ja: {
    ...
    zen: {
      ...
      bodhidharmaDesc: '菩提達摩は5-6世紀の半伝説的な仏教僧です。禅宗の開祖とされています。',
      sectionRiver: '水滸伝（1998年）',
      riverTitle: '水滸伝 — 中国古典文学',
      riverDesc: '43話の中国歴史ドラマ。中国文学の四大古典小説の一つに基づく。108人の英雄の物語。',
      sectionShaolin: '少林映画',
      shaolinTitle: '少林寺',
      shaolinDesc: '伝説の少林寺とその武僧についての映画。',
      sectionFilms: 'その他の映画とドラマ',
      filmsTitle: '仏教シネマ',
      filmsDesc: '仏教的テーマを探る映画とドラマのコレクション。',
  ...
  pt: {
    ...
    zen: {
      title: 'O Surgimento do Zen — Bodhidharma e Artes Marciais',
      intro: 'A história de Bodhidharma (Daruma) — o 24º patriarca do budismo que trouxe o Chan (Zen) para a China.',
      sectionBodhidharma: 'Bodhidharma (Daruma)',
      bodhidharmaDesc: 'Bodhidharma é um monge budista semi-legendário dos séculos V-VI. É considerado o fundador do budismo Chan (Zen).',
      sectionRiver: 'Margem da Água (1998)',
      riverTitle: 'Margem da Água — Clássico Chinês',
      riverDesc: 'Um drama histórico chinês de 43 episódios baseado em um dos quatro grandes romances clássicos da literatura chinesa.',
      ...
      sectionFilms: 'Mais Filmes e Séries',
      filmsTitle: 'Cinema Budista',
      filmsDesc: 'Uma coleção selecionada de filmes e séries que exploram temas budistas.',
  ...
  th: {
    ...
    zen: {
      title: 'การกำเนิดเซน — พระพุทธธัมมาและศิลปะการต่อสู้',
      intro: 'เรื่องราวของพระพุทธธัมมา (Daruma) — พระปิตุจฉาองค์ที่ 24 ของพระพุทธศาสนา',
      sectionBodhidharma: 'พระพุทธธัมมา (Daruma)',
      bodhidharmaDesc: 'พระพุทธธัมมาเป็นพระสงฆ์พุทธกึ่ง.legendary แห่งศตวรรษที่ 5-6',
      sectionRiver: 'มังกรแม่น้ำ (1998)',
      riverTitle: 'มังกรแม่น้ำ — คลาสสิกจีน',
      riverDesc: 'ละครประวัติศาสตร์จีน 43 ตอน',
      sectionShaolin: 'ภาพยนตร์เส้าหลิน',
      shaolinTitle: 'วัดเส้าหลิน',
      shaolinDesc: 'ภาพยนตร์เกี่ยวกับวัดเส้าหลินในตำนานและพระสงฆ์นักรบ',
      sectionFilms: 'ภาพยนตร์และละครอื่นๆ',
      filmsTitle: 'ภาพยนตร์พุทธศาสนา',
      filmsDesc: 'คอลเลกชันภาพยนตร์และละครที่สำรวจ主题พุทธศาสนา',
  ...
  vi: {
    ...
    zen: {
      ...
      bodhidharmaDesc: 'Bồ Đề Đạt Ma là nhà sư Phật giáo bán huyền thoại sống vào thế kỷ 5-6.',
      sectionRiver: 'Thủy Hử (1998)',
      riverTitle: 'Thủy Hử — Tác phẩm kinh điển Trung Hoa',
      riverDesc: 'Phim truyền hình lịch sử Trung Hoa 43 tập dựa trên một trong Tứ đại danh tác.',
      ...
      sectionFilms: 'Phim và Phim Truyền Hình Khác',
      filmsTitle: 'Điện Ảnh Phật Giáo',
      filmsDesc: 'Bộ sưu tập phim khám phá chủ đề Phật giáo.',
  ...
  ko: {
    ...
    zen: {
      title: '선의 탄생 — 보디드하르마와 무술',
      intro: '보디드하르마 (다루마) 이야기 — 불교 24대 조사, 선(Chan)을 중국에 전파.',
      sectionBodhidharma: '보디드하르마 (다루마)',
      bodhidharmaDesc: '보디드하르마는 5-6세기의 반전설적 불교 승려입니다. 선종의 창시자로 알려져 있습니다.',
      sectionRiver: '수호전 (1998)',
      riverTitle: '수호전 — 중국 고전',
      riverDesc: '43화 중국 사극. 중국 문학 4대 고전 중 하나에 기반.',
      sectionShaolin: '소림 영화',
      shaolinTitle: '소림사',
      shaolinDesc: '전설적인 소림사와 그들의 승려 전사들에 대한 영화.',
      sectionFilms: '기타 영화와 드라마',
      filmsTitle: '불교 영화',
      filmsDesc: '불교 주제를 탐구하는 영화와 드라마 모음.',
  ...
  id: {
    ...
    zen: {
      title: 'Bangkitnya Zen — Bodhidharma dan Seni Bela Diri',
      intro: 'Kisah Bodhidharma (Daruma) — Patriark ke-24 Buddha yang membawa Chan (Zen) ke China.',
      sectionBodhidharma: 'Bodhidharma (Daruma)',
      bodhidharmaDesc: 'Bodhidharma adalah biksu Buddha semi-legendaris abad ke-5-6. Dia dianggap sebagai pendiri Zen.',
      sectionRiver: 'Air Mancur (1998)',
      riverTitle: 'Air Mancur — Klasik Tiongkok',
      riverDesc: 'Drama sejarah Tiongkok 43 episode berdasarkan salah satu dari Empat Novel Klasik Besar Sastra Tiongkok.',
      ...
      sectionFilms: 'Film dan Seri Lainnya',
      filmsTitle: 'Sinema Buddha',
      filmsDesc: 'Koleksi film dan seri yang menjelajahi tema-tema Buddha.',
  ...
  ms: {
    ...
    zen: {
      title: 'Kebangkitan Zen — Bodhidharma dan Seni Mempertahankan Diri',
      intro: 'Kisah Bodhidharma (Daruma) — Patriark ke-24 Buddha yang membawa Chan (Zen) ke China.',
      sectionBodhidharma: 'Bodhidharma (Daruma)',
      bodhidharmaDesc: 'Bodhidharma adalah sami Buddha separuh-legenda abad ke-5-6.',
      sectionRiver: 'Air Mancur (1998)',
      riverTitle: 'Air Mancur — Klasik China',
      riverDesc: 'Drama sejarah China 43 episod berdasarkan salah satu daripada Empat Novel Agung Kesusasteraan China.',
      sectionShaolin: 'Filem Shaolin',
      shaolinTitle: 'Kuil Shaolin',
      shaolinDesc: 'Filem tentang biara Shaolin yang legenda dan sami pejuangnya.',
      sectionFilms: 'Filem dan Siri Lain',
      filmsTitle: 'Pawagam Buddha',
      filmsDesc: 'Koleksi filem dan siri yang meneroka tema Buddha.',
  ...
  si: {
    ...
    zen: {
      title: 'දේශන්ගේ උපත — බෝධිධර්ම සහ සටන් කලා',
      intro: 'බෝධිධර්ම (දාරුම) ගේ කතාව — බුද්ධාගමේ 24 වන පියා.',
      sectionBodhidharma: 'බෝධිධර්ම (දාරුම)',
      bodhidharmaDesc: 'බෝධිධර්ම යනු 5-6 වන සියවසේ අර්ධ-පුරාවෘත්ත බෞද්ධ භික්ෂුවෙකි.',
      sectionRiver: 'ජල ඉවුර (1998)',
      riverTitle: 'ජල ඉවුර — චීන ක්ලාසික්',
      riverDesc: 'චීන සාහිත්‍යයේ මහා ක්ලාසික් නවකතා හතරෙන් එකක් මත පදනම් වූ 43 කොටස් චීන ඉතිහාස නාට්‍යයකි.',
      ...
      sectionFilms: 'වෙනත් චිත්‍රපට සහ මාලා',
      filmsTitle: 'බෞද්ධ සිනමා',
      filmsDesc: 'බෞද්ධ තේමා ගවේෂණය කරන චිත්‍රපට සහ මාලා එකතුවකි.',
  ...
  my: {
    ...
    zen: {
      title: 'ဇင်၏မွေးဖွားခြင်း — ဗောဓိဓမ္မနှင့် တိုက်ခိုက်ရေး',
      intro: 'ဗောဓိဓမ္မ (ဒါရုမ) ၏ပုံပြင် — ဗုဒ္ဓဘာသာ၏ ၂၄ ဦးမြောက်ပဉ္ဇယ',
      sectionBodhidharma: 'ဗောဓိဓမ္မ (ဒါရုမ)',
      bodhidharmaDesc: 'ဗောဓိဓမ္မသည် ရ-၆ ရာစုနှစ်က တစ်ဝက်တစ်ပိုင်းဒဏ္ဍာရီဆန်သော ဗုဒ္ဓဘာသာဆရာတော်ဖြစ်သည်',
      sectionRiver: 'ရေမြစ် (1998)',
      riverTitle: 'ရေမြစ် — တရုတ်ကျမ်းဂန်',
      riverDesc: 'တရုတ်စာပေ၏ကြီးကျယ်သောကျမ်းဂန် ၄ စောင်မှတစ်ခုအပေါ်အခြေခံသည့် ၄၃ ဇာတ်လမ်းရှိသည့် သမိုင်းဝင်ဇာတ်လမ်းတွဲဖြစ်သည်',
      ...
      sectionFilms: 'အခြားရုပ်ရှင်များနှင့် ဇာတ်လမ်းတွဲများ',
      filmsTitle: 'ဗုဒ္ဓရုပ်ရှင်',
      filmsDesc: 'ဗုဒ္ဓဘာသာရေးရာအကြောင်းအရာများကို စူးစမ်းလေ့လာသည့် ရုပ်ရှင်များနှင့် ဇာတ်လမ်းတွဲများ စုစည်းမှု',
  ...
  ne: {
    ...
    zen: {
      title: 'जेनको उत्पत्ति — बोधिधर्म र मार्शल आर्ट्स',
      intro: 'बोधिधर्म (दारुमा) को कथा — बौद्ध धर्मको 24 औं पितृ जसले चान (जेन) चीनमा लगे।',
      sectionBodhidharma: 'बोधिधर्म (दारुमा)',
      bodhidharmaDesc: 'बोधिधर्म ५-६ औं शताब्दीका अर्ध-पौराणिक बौद्ध भिक्षु हुन्।',
      sectionRiver: 'नदी किनार (1998)',
      riverTitle: 'नदी किनार — चिनियाँ शास्त्रीय',
      riverDesc: 'चिनियाँ साहित्यका चार महान शास्त्रीय उपन्यासमध्ये एकमा आधारित ४३ एपिसोडको ऐतिहासिक नाटक।',
      ...
      sectionFilms: 'अन्य फिल्महरू र धारावाहिक',
      filmsTitle: 'बौद्ध सिनेमा',
      filmsDesc: 'बौद्ध विषयहरू खोज्ने फिल्महरू र धारावाहिकको संकलन।',
  ...
  bo: {
    ...
    zen: {
      title: 'བསམ་གཏན་གྱི་འབྱུང་ཁུངས།',
      intro: 'བྱང་ཆུབ་ཐུབ་པའི་དབལ (ད་རུ་མ) གྱི་ལོ་རྒྱུས།',
      sectionBodhidharma: 'བྱང་ཆུབ་ཐུབ་པའི་དབལ (ད་རུ་མ)',
      bodhidharmaDesc: 'བྱང་ཆུབ་ཐུབ་པའི་དབལ་ནི་དུས་རབས་5-6 པའི་གནའ་རྙིང་བཅོམ་ལྡན་འདས་ཀྱི་དགེ་བཤེས་ཤིག་ཡིན།',
      sectionRiver: 'ཆུ་འགྲམ (1998)',
      riverTitle: 'ཆུ་འགྲམ — ཀྲུང་གོའི་དཔེ་རྙིང་།',
      riverDesc: 'ཀྲུང་གོའི་རྩོམ་རིག་གི་དཔེ་རྙིང་ཆེན་མོ་བཞིའི་ཡ་གྱལ་ལ་བརྟེན་པའི་ལོ་རྒྱུས་ཟློས་གར་ཞིག',
      ...
      sectionFilms: 'གློག་བརྙན་དང་ཟློས་གར་གཞན་དག',
      filmsTitle: 'བཅོམ་ལྡན་འདས་ཀྱི་གློག་བརྙན།',
      filmsDesc: 'བཅོམ་ལྡན་འདས་ཀྱི་བརྗོད་བྱ་འཚོལ་ཞིབ་བྱེད་པའི་གློག་བརྙན་དང་ཟློས་གར་གྱི་ཚོགས་པ།',
