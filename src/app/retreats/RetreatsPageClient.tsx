...
export default function RetreatsPageClient() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="font-[var(--font-cormorant)] text-4xl font-bold text-amber-900 dark:text-amber-700 text-center mb-8">
        {t.nav.retreats}
      </h1>
      ...
      {tab === 'centers' && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {retreats.map((r) => (
            <div key={r.id} className="group bg-white dark:bg-gray-900 rounded-2xl shadow border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-xl hover:border-amber-300 dark:hover:border-amber-700 transition-all duration-300">
              <div className="relative aspect-[1440/752] overflow-hidden">
                <img
