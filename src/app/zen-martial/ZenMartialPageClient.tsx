  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, rgba(255,255,255,0.7) 0%, rgba(255,255,255,0.95) 40%, rgba(255,255,255,0.98) 100%)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="rounded-3xl p-8 md:p-12 mb-4" style={{ background: 'linear-gradient(180deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.95) 100%)', border: '1px solid rgba(245, 158, 11, 0.08)' }}>
          ...
          <div className="flex justify-center mb-8">
            <div className="relative rounded-2xl overflow-hidden" style={{ maxWidth: '320px', border: '2px solid rgba(245, 158, 11, 0.15)', boxShadow: '0 0 40px rgba(245, 158, 11, 0.08)' }}>
              <img
                ...
                loading="lazy"
              />
              <div className="absolute bottom-0 left-0 right-0 px-3 py-2 text-center" style={{ background: 'linear-gradient(transparent, rgba(255,255,255,0.9))' }}>
                <p className="text-amber-600/40 text-xs">Цукиока Ёситоси, 1887</p>
              </div>
            </div>
          </div>

          <p className="text-amber-700/50 text-center text-lg leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="golden-card rounded-2xl p-6 text-center">
                ...
                <h3 className="font-[var(--font-cormorant)] text-lg font-bold text-amber-700/80 mb-2">{item.title}</h3>
                <p className="text-amber-600/40 text-sm">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="rounded-3xl p-8 md:p-12 mb-4" style={{ background: 'linear-gradient(180deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.95) 100%)', border: '1px solid rgba(245, 158, 11, 0.08)' }}>
          ...
          <h3 className="font-[var(--font-cormorant)] text-xl text-center text-amber-600/60 mb-6">
            {t.zen.dharmachakraTitle}
          </h3>
          <p className="text-amber-700/50 text-center text-base leading-relaxed max-w-3xl mx-auto mb-8">
              ...
              return (
                <div key={film.id} className="golden-card rounded-2xl overflow-hidden">
                  ...
                  >
                    ...
                    <h3 className="font-[var(--font-cormorant)] text-lg font-bold text-amber-700/80">
                  ...
                  {isOpen && (
                    <div className="px-5 pb-5 space-y-3 text-sm animate-fade-in" style={{ borderTop: '1px solid rgba(245, 158, 11, 0.1)' }}>
                      <div className="flex flex-wrap gap-x-6 gap-y-1 pt-3 text-amber-600/40">
                        <span><strong className="text-amber-500/60">{locale === 'ru' ? 'Режиссёр:' : 'Director:'}</strong> {(film.directors as any)[locale] || film.directors.en}</span>
                        <span><strong className="text-amber-500/60">{locale === 'ru' ? 'Актёры:' : 'Cast:'}</strong> {(film.actors as any)[locale] || film.actors.en}</span>
                      </div>
                      ...
                      {film.link && (
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 text-amber-400 hover:text-amber-500 transition-colors text-xs"
                        >
          ...
          <div className="space-y-3">
            ...
            <div className="golden-card rounded-2xl overflow-hidden">
              ...
              {openMartialFilm === 'kung-fu-panda' && (
                <div className="px-5 pb-5 space-y-3 text-sm animate-fade-in" style={{ borderTop: '1px solid rgba(245, 158, 11, 0.1)' }}>
                  <div className="flex flex-wrap gap-x-6 gap-y-1 pt-3 text-amber-600/40">
                    <span><strong className="text-amber-500/60">{locale === 'ru' ? 'Режиссёр:' : 'Director:'}</strong> {locale === 'ru' ? 'Марк Осборн, Джон Стивенсон' : 'Mark Osborne, John Stevenson'}</span>
                    <span><strong className="text-amber-500/60">{locale === 'ru' ? 'Актёры:' : 'Cast:'}</strong> {locale === 'ru' ? 'Джек Блэк, Дастин Хоффман, Анджелина Джоли' : 'Jack Black, Dustin Hoffman, Angelina Jolie'}</span>
                  </div>
                  <p className="text-amber-700/50 leading-relaxed">
            ...
            <div className="golden-card rounded-2xl overflow-hidden">
              ...
              {openMartialFilm === 'river-margin' && (
                <div className="px-5 pb-5 space-y-3 text-sm animate-fade-in" style={{ borderTop: '1px solid rgba(245, 158, 11, 0.1)' }}>
                  <p className="text-amber-700/50 leading-relaxed pt-3">
                    {locale === 'ru'
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-amber-400 hover:text-amber-500 transition-colors text-xs font-medium"
                  >
                    <svg
        ...
        <section className="mb-4">
          ...
          <p className="text-amber-600/50 text-center text-base leading-relaxed max-w-3xl mx-auto mb-8">
            {t.zen.zenSpreadDesc}
          </p>
