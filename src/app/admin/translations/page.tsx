    ...
    <div className="flex min-h-screen flex-col">
      <header className="border-b border-amber-200 dark:border-amber-800/30 bg-white dark:bg-gray-900 px-6 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <h1 className="text-xl font-bold text-amber-900 dark:text-amber-700">
            Admin: Translation Management
          </h1>
          <span className="rounded-lg bg-amber-100 dark:bg-amber-900/30 px-3 py-1 text-sm text-amber-700 dark:text-amber-500">
            Admin Panel
          </span>
        </div>
      </header>
                  ...
                  <button
                    ...
                    className={`w-full rounded-lg px-3 py-2 text-left text-sm transition-colors ${
                      selectedArticle === article.id
                        ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-900 dark:text-amber-700'
                ...
                <>
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={handleSave}
                        className="rounded-lg bg-amber-100 dark:bg-amber-900/30 px-3 py-1.5 text-sm text-amber-700 dark:text-amber-500 hover:bg-amber-200 dark:hover:bg-amber-800/30 transition-colors"
                      >
