...
const tiers = {
  en: [
    { icon: Coffee, name: 'Supporter', amount: '$3', desc: 'Buy us a coffee. Every contribution matters.', color: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-500' },
  ...
  ru: [
    { icon: Coffee, name: 'Поддержка', amount: '300 ₽', desc: 'Купите нам кофе. Каждый вклад важен.', color: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-500' },
    ...
    <div>
      <section className="relative bg-gradient-to-b from-amber-800 via-amber-900 to-amber-950 text-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 md:py-28 text-center relative z-10">
          ...
          <p className="text-amber-600/80 text-lg md:text-xl max-w-2xl mx-auto mb-8">
            {lang.hero_subtitle}
          </p>
          <a
            href={BOOSTY_URL}
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <h2 className="font-[var(--font-cormorant)] text-3xl font-bold text-center text-amber-900 dark:text-amber-700 mb-10">
          {lang.why_title}
        </h2>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-16">
        <h2 className="font-[var(--font-cormorant)] text-3xl font-bold text-center text-amber-900 dark:text-amber-700 mb-2">
          {lang.tiers_title}
        </h2>
      ...
      <div className="bg-amber-100 dark:bg-amber-900/30 py-8">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <p className="text-amber-800 dark:text-amber-600 italic font-[var(--font-cormorant)] text-xl">
            {locale === 'ru'
