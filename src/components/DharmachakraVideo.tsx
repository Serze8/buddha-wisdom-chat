...
function VideoDescription() {
  ...
  return (
    <div className="rounded-2xl p-6 mb-8" style={{ background: '#ffffff', border: '1px solid #e7e5e4' }}>
      <h3 className="font-[var(--font-jakarta)] text-xl font-semibold text-slate-800 mb-3">
        {desc.title}
      </h3>
      <p className="text-slate-500 text-sm mb-4 leading-relaxed">{desc.desc}</p>
...
function TranscriptSection() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: '#ffffff', border: '1px solid #e7e5e4' }}>
      ...
      >
        <h3 className="font-[var(--font-jakarta)] text-xl font-semibold text-slate-800">
          Video Transcript
        </h3>
        <svg
      ...
      {open && (
        <div className="px-6 pb-6 animate-fade-in">
          ...
          <div key={animKey} className="max-h-60 overflow-y-auto rounded-xl p-4 space-y-3 text-sm text-slate-500 leading-relaxed animate-fade-in" style={{ background: '#fafaf9', border: '1px solid #f5f5f4' }}>
            {transcriptData.map((row, i) => (
              <p key={i}>
                <strong className="text-blue-600 font-mono">{row.time}</strong>{' '}
...
export default function DharmachakraVideo() {
  return (
    <div className="rounded-3xl p-8 md:p-12" style={{ background: 'linear-gradient(180deg, #fafaf9 0%, #f5f5f4 100%)', border: '1px solid #e7e5e4' }}>
