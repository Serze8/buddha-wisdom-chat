      ...
      <div className="grid md:grid-cols-3 gap-6 stagger-children">
        {teachers.map((teacher) => (
          ...
          >
            ...
            <p className="font-[var(--font-cormorant)] text-lg leading-relaxed mb-6 italic relative z-10 pl-6" style={{ color: '#78716c' }}>
              {teacher.quote[locale] || teacher.quote.en}
            </p>

            <div className="flex items-center gap-3 pt-5 relative z-10" style={{ borderTop: '1px solid #e7e5e4' }}>
              <div className="w-11 h-11 rounded-full flex items-center justify-center text-xl shrink-0" style={{ background: 'linear-gradient(135deg, rgba(245, 158, 11, 0.15), rgba(245, 158, 11, 0.05))', border: '1px solid rgba(245, 158, 11, 0.2)' }}>
                {teacher.emoji}
              </div>
              <div>
