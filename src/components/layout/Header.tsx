...
const navItems = [
  'home', 'buddha', 'chakravartin', 'dharmaChats', 'characters', 'episodes', 'teachings', 'zenMartial',
      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        <Link href="/" className="flex items-center gap-2 font-bold text-lg text-amber-100">
          <div className="relative w-9 h-9 rounded-full overflow-hidden shrink-0">
            <Image src="/images/logo.png" alt="Buddha-Chakravartin" fill className="object-cover" />
          </div>
          <span className="hidden sm:inline">Buddha-Chakravartin</span>
        </Link>
