...
export default function RitualBreathingPractice() {
  ...
  const ringColor = phase === 'inhale' ? 'rgba(245, 158, 11, 0.12)'
    ...
    : phase === 'exhale' ? 'rgba(217, 119, 6, 0.12)'
      ...
      <div className="w-full max-w-[320px] mx-auto mt-3 mb-4 flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          <div className="flex justify-between text-sm font-light opacity-70">
            <span className="text-amber-600/50">☸ {labels.inhaleSlider}</span>
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between text-sm font-light opacity-70">
            <span className="text-amber-600/50">🕉 {labels.holdSlider}</span>
            <span className="tabular-nums px-2 rounded-full text-amber-500/60" style={{ background: 'rgba(245, 158, 11, 0.05)' }}>{holdDuration.toFixed(1)}</span>
          </div>
          <input
            type="range"
            min={2}
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between text-sm font-light opacity-70">
            <span className="text-amber-600/50">ॐ {labels.exhaleSlider}</span>
            <span className="tabular-nums px-2 rounded-full text-amber-500/60" style={{ background: 'rgba(245, 158, 11, 0.05)' }}>{exhaleDuration.toFixed(1)}</span>
          </div>
          <input
            type="range"
            min={2}
